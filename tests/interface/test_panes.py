...
def test_MicroPythonREPLPane_keyPressEvent_delete(qtapp):
    ...
    data.modifiers = mock.MagicMock(return_value=Qt.NoModifier)
    rp.keyPressEvent(data)
    mock_serial.write.assert_called_once_with(mu.interface.panes.VT100_DELETE)
...
def test_MicroPythonREPLPane_keyPressEvent_up(qtapp):
    ...
    data.modifiers = mock.MagicMock(return_value=Qt.NoModifier)
    rp.keyPressEvent(data)
    mock_serial.write.assert_called_once_with(mu.interface.panes.VT100_UP)
...
def test_MicroPythonREPLPane_keyPressEvent_down(qtapp):
    ...
    data.modifiers = mock.MagicMock(return_value=Qt.NoModifier)
    rp.keyPressEvent(data)
    mock_serial.write.assert_called_once_with(mu.interface.panes.VT100_DOWN)
...
def test_MicroPythonREPLPane_keyPressEvent_right(qtapp):
    ...
    data.modifiers = mock.MagicMock(return_value=Qt.NoModifier)
    rp.keyPressEvent(data)
    mock_serial.write.assert_called_once_with(mu.interface.panes.VT100_RIGHT)
...
def test_MicroPythonREPLPane_keyPressEvent_left(qtapp):
    ...
    data.modifiers = mock.MagicMock(return_value=Qt.NoModifier)
    rp.keyPressEvent(data)
    mock_serial.write.assert_called_once_with(mu.interface.panes.VT100_LEFT)
...
def test_MicroPythonREPLPane_keyPressEvent_home(qtapp):
    ...
    data.modifiers = mock.MagicMock(return_value=Qt.NoModifier)
    rp.keyPressEvent(data)
    mock_serial.write.assert_called_once_with(mu.interface.panes.VT100_HOME)
...
def test_MicroPythonREPLPane_keyPressEvent_end(qtapp):
    ...
    data.modifiers = mock.MagicMock(return_value=Qt.NoModifier)
    rp.keyPressEvent(data)
    mock_serial.write.assert_called_once_with(mu.interface.panes.VT100_END)
...
def test_MicroPythonREPLPane_keyPressEvent_ctrl_passthrough_darwin(qtapp):
    """
    Ensure backspaces in the REPL are handled correctly.
    """
    mock_serial = mock.MagicMock()
...
def test_MicroPythonREPLPane_keyPressEvent_ctrl_passthrough_windows(qtapp):
    """
    Ensure backspaces in the REPL are handled correctly.
    """
    mock_serial = mock.MagicMock()
...
def test_MicroPythonREPLPane_set_qtcursor_to_devicecursor(qtapp):
    """
...
def test_MicroPythonREPLPane_set_devicecursor_to_qtcursor(qtapp):
    """
...
def test_MicroPythonREPLPane_set_move_cursor_to_right(qtapp):
    """
...
def test_MicroPythonREPLPane_set_move_cursor_to_left(qtapp):
    """
    Test that move_cursor_to sends the appropriate
...
def test_MicroPythonREPLPane_delete_selection(qtapp):
    """
...
def test_MicroPythonREPLPane_delete_selection_w_no_selection(qtapp):
    """
...
def test_MicroPythonREPLPane_mouseReleasedEvent_no_selection(qtapp):
    """
...
def test_MicroPythonREPLPane_mouseReleasedEvent_with_selection(qtapp):
    """
...
def test_MicroPythonREPLPane_process_bytes_backspace(qtapp):
    """
...
def test_MicroPythonREPLPane_process_bytes_carriage_return(qtapp):
    """
...
def test_MicroPythonREPLPane_process_bytes_newline(qtapp):
    """
...
def test_MicroPythonREPLPane_process_bytes_printed_chars(qtapp):
    """
...
def test_MicroPythonREPLPane_process_bytes_vt100_cursor_left(qtapp):
    """
...
def test_MicroPythonREPLPane_process_bytes_vt100_cursor_right(qtapp):
    """
...
def test_MicroPythonREPLPane_process_bytes_partial_reception(qtapp):
    """
...
def test_MicroPythonREPLPane_process_bytes_partial_reception2(qtapp):
    """
    Ensure that when partially received multibyte commands are
    received they are handled properly
    """
...
def test_MicroPythonREPLPane_process_bytes_unsupported_vt100_command(qtapp):
    """
